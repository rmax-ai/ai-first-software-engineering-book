...
- `git --no-pager show HEAD:state/migration_iterations/iter_078/01-task.md | rg -nF '\`uv run python state/copilot_sdk_smoke_test.py --mode fallback-error\`'` confirms pre-edit legacy wording.
