...
## Why it is next
The helper rollout is incremental and still has many repetitive wrappers left; another two-wrapper slice keeps risk low while continuing cleanup.
...
- `state/feature_iterations/iter_082/*.md`
