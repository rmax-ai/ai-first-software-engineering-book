...
The update changed exactly one escaped command snippet mention in `state/migration_iterations/iter_078/01-task.md`.
...
All seven required iteration artifacts were created under `state/migration_iterations/iter_080/`.
A single concrete next task was documented for `iter_079/01-task.md` normalization.
