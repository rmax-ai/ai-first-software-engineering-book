...
- `view state/migration_iterations/iter_051/06-next-iteration.md`
- `view state/migration_iterations/iter_020/03-execution.md`
- `view state/migration_iterations/iter_020/04-validation.md`
- `view state/migration_iterations/iter_021/03-execution.md`
- `view state/migration_iterations/iter_021/04-validation.md`
- `apply_patch` on selected historical files in `iter_020` and `iter_021`
