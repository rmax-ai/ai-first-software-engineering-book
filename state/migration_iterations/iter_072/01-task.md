...
- Replace `python state/copilot_sdk_smoke_test.py --mode fallback-error` snippet mention with `uv run python state/copilot_sdk_smoke_test.py --mode fallback-error` in `state/migration_iterations/iter_068/06-next-iteration.md`.
