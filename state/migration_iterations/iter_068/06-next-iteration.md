...
- `rg -n "\`python state/copilot_sdk_smoke_test.py --mode fallback-error\`" state/migration_iterations/iter_066/04-validation.md` confirms the legacy mention before edit.
