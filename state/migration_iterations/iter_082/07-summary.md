...
The change updated exactly one escaped command snippet mention in `state/migration_iterations/iter_080/01-task.md`.
...
All seven required iteration artifacts were created under `state/migration_iterations/iter_082/`.
A single concrete next task was documented for `state/migration_iterations/iter_081/01-task.md` normalization.
