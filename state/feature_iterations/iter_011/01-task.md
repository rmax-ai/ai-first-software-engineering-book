# Task: Add deterministic missing-chapter guard smoke mode

## Why this task now
`state/feature_iterations/iter_010/06-next-iteration.md` identified missing-chapter guard coverage as the next unfinished `_get_latest_trace_summary` gap.
