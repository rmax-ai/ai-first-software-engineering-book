...
- Pre-edit evidence confirms `state/migration_iterations/iter_077/01-task.md` contained escaped `uv run python state/copilot_sdk_smoke_test.py --mode fallback-error` wording.
