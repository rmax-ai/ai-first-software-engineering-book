...
- `rg -nF 'python state/copilot_sdk_smoke_test.py --mode fallback-error' state/migration_iterations/iter_082/01-task.md` confirms the remaining legacy snippet mention.
