...
- Migrated exactly two wrappers (11-guard and 12-guard variants) to match prior handoff scope.
- Preserved wrapper names and PASS strings exactly, prioritizing deterministic behavior over broader cleanup.

## Deferred intentionally
- Remaining duplicate-count coverage-guard wrappers (13+ guard variants) are deferred to later iterations.
