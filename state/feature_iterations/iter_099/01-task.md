...
## Selected task title
Add a smoke guard mode that enforces duplicate-count coverage-guard wrappers use canonical PASS message suffixes.

## Why this task now
`state/feature_iterations/iter_098/06-next-iteration.md` identifies PASS suffix drift as the next smallest deterministic regression surface after prefix enforcement.
