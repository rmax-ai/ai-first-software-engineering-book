...
- Command 2 output: `PASS: usage-examples-duplicate-count-mode-coverage-guard-coverage-guard-coverage-guard-coverage-guard-coverage-guard-coverage-guard-coverage-guard-coverage-guard-coverage-guard-coverage-guard-coverage-guard-coverage-guard-coverage-guard-coverage-guard-coverage-guard-coverage-guard-coverage-guard-coverage-guard-coverage-guard-coverage-guard-coverage-guard-coverage-guard mode validates duplicate-count ... mode coverage`

## Pass/fail against acceptance criteria
- Acceptance criterion 1: **Pass** (new 22-suffix handler added).
- Acceptance criterion 2: **Pass** (new 22-suffix mode registered in `TRACE_SUMMARY_MODE_SPECS`).
