...
- `trace-summary-kernel-fixture-root-cleanup`: **PASS** — `PASS: trace-summary-kernel-fixture-root-cleanup mode validates trace-summary fixture root cleanup after kernel trace-summary runs`
